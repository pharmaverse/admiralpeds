# admiralpeds Unit Testing Guidelines for AI Assistants

Context for AI assistants when working with admiralpeds unit tests inside `tests/testthat/`.
...
> `# admiralpeds test guidelines loaded` on the first line of every **new** test file  
