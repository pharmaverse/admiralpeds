...
(i.e. growth development chart) parameter derivations.
...
might want to use a different age range selection of WHO metadata or
even use International Obesity Task Force standards.
...
Note that head circumference metadata comes only from the WHO standards,
as no equivalent for \>2 years of age are provided by CDC.
...
dataset_vignette(
  advs,
  display_vars = exprs(USUBJID, AAGECUR, AAGECURU, PARAMCD, PARAM, AVAL),
...
notice the function is very similar to that used above, but now using
