...
The `derive_params_growth_age()` and `derive_params_growth_height()` functions require
that the age unit in your input data **exactly matches** the age unit in your metadata.
The functions do **NOT** automatically convert between age units.
