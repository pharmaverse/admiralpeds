...
(see document page 302). The intended rationale is to overcome right skewness in
the data, where WHO decided to not rely on the usual LMS method for extreme
values and instead an extrapolation approach is recommended.
Of course here if you were choosing to not use WHO metadata then you could
equally leave `who_correction = FALSE` and the extra extrapolation step would
be ignored.
