...
parameter and ensuring gender and age are shown in a consistent way.
...
day of age. If you prefer to rely solely on the monthly chart here, then
you could remove the call to the `derive_interp_records()` function.
