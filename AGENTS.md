# admiralpeds Development Guidelines for AI Assistants

This file provides context for AI coding assistants (GitHub Copilot, Gemini, Claude, Cursor, etc.) about admiralpeds ecosystem standards and best practices.
...
> `# admiralpeds guidelines loaded` on the first line of every **new** R file  
...
> include the comment `# admiralpeds test guidelines loaded` at the top of every new test file.
